  ...
  return (
    <div className="min-h-screen bg-transparent text-text-primary">
      <div className="flex flex-col">
            ...
            {[
              ...
              <li
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium
                           bg-surface-light/50 border border-border text-text-secondary"
              >
        ...
        <p className="text-center text-xs text-text-muted/60 mb-10 px-4" role="note">
        ...
        >
          ...
          {/* Legal microcopy */}
          <p className="text-center text-xs text-text-muted/50 mt-8 max-w-md mx-auto">
            All prices in USD. Yearly plans billed annually.{" "}
            <a href="/legal/refunds" className="underline underline-offset-2 hover:text-text-secondary transition-colors">
              Refund policy
            </a>{" "}
            ·{" "}
            <a href="/legal/terms" className="underline underline-offset-2 hover:text-text-secondary transition-colors">
              Terms of service
            </a>
          </p>
        </section>
        ...
        >
          ...
          <p className="text-text-secondary mb-8 text-base max-w-md mx-auto leading-relaxed">
