        ...
        return (
          ...
          >
            ...
            >
              ...
              <svg
                aria-hidden="true"
                className={`flex-shrink-0 w-4 h-4 text-text-muted transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
                viewBox="0 0 16 16"
                fill="none"
              >
                <path
            ...
            >
              <p className="px-5 pb-5 pt-1 text-sm leading-relaxed text-text-secondary">
                {faq.a}
              </p>
            </div>
          </div>
